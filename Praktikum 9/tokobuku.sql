...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 12, 2025 at 05:35 AM
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `tambah_transaksi` (IN `p_id_pelanggan` INT, IN `p_id_buku` INT, IN `p_jumlah` INT)   BEGIN
    ...
    IF v_stok < p_jumlah THEN
        ...
        SET MESSAGE_TEXT = 'Stok tidak mencukupi untuk transaksi';
    ELSE
...
(1, 'Belajar SQL', 'Budi Santoso', 150000.00, 7);
...
(1, 'Andi Wijaya', 450000.00, 'REGULER');
